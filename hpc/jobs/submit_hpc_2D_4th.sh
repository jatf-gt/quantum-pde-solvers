#!/bin/bash
# ============================================================
#  submit_hpc_2D_4th.sh
#  PBS Pro job submission script for Imperial College CX3 HPC.
#
#  Runs the full 2-D benchmark sweep for the 4th order scheme,
#  N = 4..16, all cases, all solvers (Thomas, HHL, VQLS, QSVT).
#
#  Usage:
...
#  Monitor:
#    qstat -u $USER
#    tail -f results/2Dhpc_run_4th/run.log
# ============================================================
...
echo "============================================================"
echo "  QUANTUM PDE SOLVER — HPC JOB START (2D 4th Order)"
...
EXTRA_ARGS="--max-workers 4 --order 4 --max-n 16"
if [ -n "${MAX_N}" ]; then
...
python3 hpc/runners/run_2d.py ${EXTRA_ARGS}
EXIT_CODE=$?
