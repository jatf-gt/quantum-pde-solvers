#!/bin/bash
# ============================================================
#  submit_hpc_3D_4th.sh
#  PBS Pro job submission script for Imperial College CX3 HPC.
#
#  Runs the full 3-D benchmark sweep for the 4th order scheme,
#  N = 4..8, all cases, all solvers (Thomas, HHL, VQLS, QSVT).
#
#  Usage:
...
#  Monitor:
#    qstat -u $USER
#    tail -f results/3Dhpc_run_4th/run.log
# ============================================================
...
echo "============================================================"
echo "  QUANTUM PDE SOLVER — HPC JOB START (3D 4th Order)"
...
EXTRA_ARGS="--max-workers 4 --order 4 --max-n 8"
if [ -n "${MAX_N}" ]; then
...
python3 hpc/runners/run_3d.py ${EXTRA_ARGS}
EXIT_CODE=$?
