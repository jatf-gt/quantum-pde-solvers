...
| Sweep (4th order) | `jobs/submit_hpc_{1D,2D,3D}_4th.sh` | `runners/run_{1,2,3}d.py --order 4` | as their 2nd-order twins | Pentadiagonal sweeps. **Do not submit these yet** — see `docs/HPC_REPAIR_PLAN.md` Phases 2, 4 and 6: HHL and QSVT currently truncate the ±2 band and solve a tridiagonal operator instead. |
